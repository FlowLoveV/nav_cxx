 ...
 *                           no support stream type STR_NTRIPC_S in API
 *stropen() no support rcv. command LEXR in API strsendcmd() change stream type
 *STR_NTRIPC_C to STR_NTRIPCAS accept HTTP/1.1 as protocol for NTRIP caster
