...
static int nextsat(nav_t *nav, int sat, int msg) {
  ...
  switch (msg) {
    case 1019: sys = SYS_GPS;
      set = 0;
      p1 = MINPRNGPS;
      p2 = MAXPRNGPS;
      break;
    case 1020: sys = SYS_GLO;
      set = 0;
      p1 = MINPRNGLO;
      p2 = MAXPRNGLO;
      break;
    case 1044: sys = SYS_QZS;
      set = 0;
      p1 = MINPRNQZS;
      p2 = MAXPRNQZS;
      break;
    case 1045: sys = SYS_GAL;
      set = 1;
      p1 = MINPRNGAL;
      p2 = MAXPRNGAL;
      break;
    case 1046: sys = SYS_GAL;
      set = 0;
      p1 = MINPRNGAL;
      p2 = MAXPRNGAL;
      break;
    case 63:
    case 1042: sys = SYS_CMP;
      set = 0;
      p1 = MINPRNCMP;
      p2 = MAXPRNCMP;
      break;
...
static void strconv(stream_t *str, strconv_t *conv, uint8_t *buff, int n) {
  ...
  for (i = 0; i < n; i++) {
    ...
    switch (ret) {
      case 1: write_obs(conv->out.time, str, conv);
        break;
      case 2: write_nav(conv->out.time, str, conv);
        break;
    }
  }
